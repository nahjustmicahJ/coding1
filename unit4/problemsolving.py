...
'to make a calculator to assist student in a test using the arithmetic operator and can also take numbers'

# 2. What are some keywords and phrases ? 
'should be able to take in a number, followed by an arithmetic operator and then another number'
